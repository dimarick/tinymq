...
func TestSerializeOperation(t *testing.T) {
	expected := []byte{116, 110, 109, 113, 1, 0, 233, 2, 0, 0, 0, 0, 0, 0, 16, 0, 0, 0, 123, 34, 116, 101, 115, 116, 34, 58, 32, 34, 100, 97, 116, 97, 34, 125}
...
func TestDeserializeOperation(t *testing.T) {
	buffer := []byte{116, 110, 109, 113, 1, 0, 233, 2, 0, 0, 0, 0, 0, 0, 16, 0, 0, 0, 123, 34, 116, 101, 115, 116, 34, 58, 32, 34, 100, 97, 116, 97, 34, 125}
